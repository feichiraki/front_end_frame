    ...
    >
      <div class="product">
        ...
        <div class="showbtn" v-if="detail.stock_total > 0">
          ...
          <div class="btn now" v-if="mode === 'buyNow'" @click="buyNowFn">立刻购买</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      // 添加到购物车
      const res = await addCart({ goodsId: this.id, goodsNum: this.addCount, goodsSkuId: this.detail.skuList[0].goods_sku_id })
      const { data } = res
